...
if( isset($_POST['update']))
{
		...
		if(empty($created_at)){
			echo "<font color='red'> created_at field is empty. </font><br/>";
				...
				$result = mysqli_query($mysqli, "UPDATE country set iso='$iso',name='$name',iso3='$iso3',numcode='$numcode',phonecode='$phonecode',created_at='$created_at' WHERE id=$id");
...
<h1><center><font color='yellow' size='10px'> Country PHP Web Application</font></h1>
